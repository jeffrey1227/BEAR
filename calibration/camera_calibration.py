...
class Calibrator:
    ...
    def run(self):
        ...
        self.load_images()
        assert len(self.imgs) >= 4, print('=> Error: need at least 4 images to calibrate')
    ...
    def load_images(self):
        ...
        #for fname in images:
        print('=> press <space> to add image')
        print('=> press <q> to exit adding and start calibration')
        while True:
            #img = cv.imread(fname)
